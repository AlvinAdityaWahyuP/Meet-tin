    ...
    <IonPage id="tutorial-page">
      ...
      <IonContent fullscreen>
        ...
        <Swiper onSwiper={setSwiper} onSlideChangeTransitionStart={handleSlideChangeStart}>
          ...
          <SwiperSlide>
            <img src="assets/img/logo/ceria.JPG" alt="" className="slide-image" />
            <h2 className="slide-title">
              Welcome to <b>Meet-tin</b>
            </h2>
            {/* <p>
          ...
          <SwiperSlide>
            ...
            <h2 className="slide-title">Ready to get ready to see a good seminar?</h2>
