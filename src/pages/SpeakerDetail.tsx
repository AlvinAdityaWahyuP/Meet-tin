...
const SpeakerDetail: React.FC<SpeakerDetailProps> = ({ speaker }) => {
  ...
  // FUNCTION FOR OPEN EXTERNAL URL
    ...
    <IonPage id="speaker-detail">
      <IonContent>
        ...
        <div className="ion-padding speaker-detail">
          ...
          <IonChip color="dark" onClick={() => openExternalUrl('https://github.com')}>
            <IonIcon icon={logoGithub}></IonIcon>
            <IonLabel>GitHub</IonLabel>
          </IonChip>

          <IonChip color="instagram" onClick={() => openExternalUrl('https://instagram.com/')}>
